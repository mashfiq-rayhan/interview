...
- Difference:  
  | Feature | JavaScript | TypeScript | |---------|-----------|------------| | Typing | Dynamic | Static optional typing | | Compilation | Interpreted by browser/Node | Compiled to JS | | Features | ES features | ES features + interfaces, enums, generics |
